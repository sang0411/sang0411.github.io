...
!function (a) {
    ...
    b = function () {
        function c(c, d) {
            ...
            e.defaults = {
                ...
                nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="Next" ta' +
                        'bindex="0" role="button">Next</button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
    ...
    b.prototype.autoPlayIterator = function () {
        ...
        a.paused || a.interrupted || a.focussed || (a.options.infinite === !1 && (
    ...
    b.prototype.changeSlide = function (b, c) {
        ...
        switch (
            ...
            case "previous":
                ...
                d.slideCount > d.options.slidesToShow && d.slideHandler(
                    d.currentSlide - g,
                    !1,
                    c
                );
    ...
    b.prototype.cleanUpEvents = function () {
        ...
        b.options.arrows === !0 && b.slideCount > b.options.slidesToShow && (
    ...
    b.prototype.destroy = function (b) {
        ...
        c.$dots && c
            .$dots
            .remove(),
        c.$prevArrow && c.$prevArrow.length && (
        ...
        c.$nextArrow && c.$nextArrow.length && (
    ...
    b.prototype.getLeft = function (a) {
        ...
        b.options.infinite === !0
            ? (
                ...
                b.slideCount % b.options.slidesToScroll !== 0 && a + b.options.slidesToScroll > b.slideCount && b.slideCount > b.options.slidesToShow && (
                    a > b.slideCount
                        ? (
    ...
    b.prototype.initDotEvents = function () {
        var b = this;
        b.options.dots === !0 && b.slideCount > b.options.slidesToShow && a(
            "li",
            b.$dots
        ).on("click.slick", {
            message: "index"
        ...
        if ("array" === a.type(f) && f.length) {
            ...
            for (c in f) 
                if (e = b.breakpoints.length - 1, d = f[c].breakpoint, f.hasOwnProperty(c)) {
                    for (; e >= 0;) 
                        b.breakpoints[e] && b.breakpoints[e] === d && b
                            .breakpoints
                            .splice(e, 1),
                        e--;
                    b
    ...
    b.prototype.reinit = function () {
        ...
        b.$slides = b
            ...
            .addClass("slick-slide"),
        b.slideCount = b.$slides.length,
        b.currentSlide >= b.slideCount && 0 !== b.currentSlide && (
    ...
    b.prototype.setProps = function () {
        ...
        void 0 !== b.transform && a.animType !== !1 && (
        ...
        b.options.centerMode === !0
            ? (c = Math.floor(b.options.slidesToShow / 2), b.options.infinite === !0 && (
                a >= c && a <= b.slideCount - 1 - c
                    ? b.$slides.slice(a - c, a + c + 1).addClass("slick-active").attr(
                        "aria-hidden",
                        "false"
                    )
                    : (
            ...
            : a >= 0 && a <= b.slideCount - b.options.slidesToShow
                ...
                : d.length <= b.options.slidesToShow
                    ...
                    : (
                        ...
                        e = b.options.infinite === !0
                            ? b.options.slidesToShow + a
                            : a,
                        b.options.slidesToShow == b.options.slidesToScroll && b.slideCount - a < b.options.slidesToShow
                            ? d.slice(e - (b.options.slidesToShow - f), e + f).addClass("slick-active").attr(
                                "aria-hidden",
                                "false"
                            )
                            : d.slice(e, e + b.options.slidesToShow).addClass("slick-active").attr(
                                "aria-hidden",
                                "false"
                            )
                    ),
    ...
    b.prototype.slideHandler = function (a, b, c) {
        ...
        i.animating === !0 && i.options.waitForAnimate === !0 || i.options.fade === !0 && i.currentSlide === a || i.slideCount <= i.options.slidesToShow
            ...
            : (
                ...
                i.currentLeft = null === i.swipeLeft
                    ? g
                    : i.swipeLeft,
                i.options.infinite === !1 && i.options.centerMode === !1 && (
                    ...
                    : i.options.infinite === !1 && i.options.centerMode === !0 && (
    ...
    b.prototype.swipeMove = function (a) {
        ...
        !b.dragging || h && 1 !== h.length
            ...
            : (
                ...
                b.touchObject.curX = void 0 !== h
                    ? h[0].pageX
                    : a.clientX,
                b.touchObject.curY = void 0 !== h
                    ? h[0].pageY
                    : a.clientY,
                ...
                "vertical" !== e
                    ? (
                        ...
                        b.options.verticalSwiping === !0 && (
                            g = b.touchObject.curY > b.touchObject.startY
                                ? 1
                                : -1
                        ),
                        f = b.touchObject.swipeLength,
                        b.touchObject.edgeHit = !1,
                        b.options.infinite === !1 && (0 === b.currentSlide && "right" === e || b.currentSlide >= b.getDotCount() && "left" === e) && (
    ...
    b.prototype.swipeStart = function (a) {
        ...
        1 !== b.touchObject.fingerCount || b.slideCount <= b.options.slidesToShow
            ...
            : (
                ...
                b.touchObject.startX = b.touchObject.curX = void 0 !== c
                    ? c.pageX
                    : a.clientX,
                b.touchObject.startY = b.touchObject.curY = void 0 !== c
                    ? c.pageY
                    : a.clientY,
                void(b.dragging = !0)
            )
    ...
    b.prototype.updateArrows = function () {
        ...
        a.options.arrows === !0 && a.slideCount > a.options.slidesToShow && !a.options.infinite && (
            ...
            0 === a.currentSlide
                ...
                : a.currentSlide >= a.slideCount - a.options.slidesToShow && a.options.centerMode === !1
                    ...
                    : a.currentSlide >= a.slideCount - 1 && a.options.centerMode === !0 && (
                        a.$nextArrow.addClass("slick-disabled").attr("aria-disabled", "true"),
                        a.$prevArrow.removeClass("slick-disabled").attr("aria-disabled", "false")
                    )
        )
